package com.chirag.mariobros.Screens;
...
import com.chirag.mariobros.Tools.B2WorldCreator;
import com.chirag.mariobros.Tools.WorldContactListener;
...
public class PlayScreen implements Screen {
   ...
   //LIBGDX ASSETMANAGER FOR MORE GRAPHICS
    ...
    public void update(float dt){
        ...
        //attach our gamecam to our player.x cordinate
        if(player.currentState != Mario.State.DEAD) {
